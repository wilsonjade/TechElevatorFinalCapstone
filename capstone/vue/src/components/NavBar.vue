<template>
  <nav id="nav">
    ...
    <router-link
      class="nav-item"
      v-bind:to="{ name: 'plantDetail', params: { plantId: 1 } }"
    >
      <svg
        class="nav-icon"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <router-link class="nav-item" v-bind:to="{ name: 'searchView' }">
      <svg
        class="nav-icon"
        xmlns="http://www.w3.org/2000/svg"
        height="1em"
    ...
    <router-link class="nav-item" v-bind:to="{ name: 'eventsView' }">
      <svg
        class="nav-icon"
        xmlns="http://www.w3.org/2000/svg"
        height="1em"
    ...
    <router-link class="nav-item" v-bind:to="{ name: 'sellersView' }">
      <svg
        class="nav-icon"
        xmlns="http://www.w3.org/2000/svg"
        height="1em"
