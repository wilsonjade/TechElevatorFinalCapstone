...
namespace Capstone.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Register(RegisterUser userParam)
        {
            ...
            try
            {
                newUser = userDao.CreateUser(userParam.Username, userParam.Password, userParam.Role, userParam.ExpertiseLevel, userParam.FirstName, userParam.LastName, userParam.Email, userParam.Region);
            }
            catch (DaoException)
            {
                return StatusCode(500, ErrorMessage);
