...
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('user','Jg45HuwT7PZkfuKTz6IB90CtWY4=','LHxP4Xh7bN0=','user', 1, 'Jade', 'Wilson', 'jade@gmail.com', 2);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('admin','YhyGVQ+Ch69n4JMBncM4lNF/i9s=', 'Ar/aB2thQTI=','admin', 2, 'Emily', 'Bates', 'emily@gmail.com', 3);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('mitch','uVCwKlk+qTovYsiaZQtaQjFqMvI=', 'j5du0U5vQa0=','user', 2, 'Mitch', 'Essig', 'mitch.essig@gmail.com', 6);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('karen','uVCwKlk+qTovYsiaZQtaQjFqMvI=', 'j5du0U5vQa0=','user', 3, 'Karen', 'Green', 'kgg@gmail.com', 4);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Enrique','9VMIvGa/lN+yNo0dq08uM7/HM7M=', 'acUePbs9PkM=','user', 2, 'Enrique', 'Iglesias', 'enrique@email.com', 2);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Freddy','v8pKpd++Z9LwAKDeKwkTR6uq8vU=', 'sr9IJzy7cOc=','user', 3, 'Freddy', 'Kruger', 'freddy@email.com', 10);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Shania','HGsmUKitwu1HB+oYvOi77HfJA6M=', 'IhFuf8BeQuY=','user', 3, 'Shania', 'Twain', 'shania@email.com', 3);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Rod','Z65G1W9px5Uaca+A3qribRdZvHY=', 'a3UoD21O7bc=','user', 2, 'Rod', 'Stewart', 'rod@email.com', 8);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Leslie','kQ85qqNy8iY29SBW41A4RzU0Op4=', 'nYgfQ/9ZKUY=','user', 3, 'Leslie', 'Knope', 'leslie@email.com', 5);
INSERT INTO users (username, password_hash, salt, user_role, expertise_level, first_name, last_name, email, region) 
	VALUES ('Jason','D4ZRo0lvurDMDVorgTSgpBNJpG0=', 'arpUmAXT+J8=','user', 1, 'Jason', 'Mendoza', 'jason@email.com', 9);
...
INSERT INTO virtual_garden (user_id, plant_id) VALUES (4,5);
INSERT INTO virtual_garden (user_id, plant_id) VALUES (4,8);
...
INSERT INTO ratings (user_id, seller_id, title, rating, review) VALUES (3, 4, 'Fresh turf', 5, 'Freshest turf in Ohio, with quick delivery.')
